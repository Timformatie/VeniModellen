...
#'
#' @description This functions creates the input dataframe for the sankey plots.
#'
#' @param dt_pred dataframe with model predictions
#' @param language language selected by user
#' @param treatment_type type of treatment, can be "therapie" or "operatie"
#'
#' @return A dataframe that can be used as input for creating the sankey plots.
#'
#' @noRd
create_plot_dataframe <- function(dt_pred, language, treatment_type) {
